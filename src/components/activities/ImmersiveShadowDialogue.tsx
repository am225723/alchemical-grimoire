...
import { MessageCircle, Heart, Brain, Sparkles, Send, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-blue-900 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Messages Area */}
        <div className="glass-card min-h-[400px] max-h-[600px] overflow-y-auto">
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <div className={`rounded-2xl px-4 py-3 ${
                        ...
                        <p className={`text-xs mt-2 ${
                          msg.sender === 'user' ? 'text-purple-200' : getToneColor(msg.emotionalTone)
                        }`}>
        ...
        {/* Input Area */}
        <div className="glass-card rounded-b-2xl border-t border-white/10 p-4">
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="px-6 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white font-medium hover:from-purple-700 hover:to-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
